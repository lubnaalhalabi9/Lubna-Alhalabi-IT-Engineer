...
const SKILLS_DATA = [
    {
        ...
        image:"./src/assets/icons/HTML-CSS.png",
        category: "Frontend",
    ...
    },
    {
        ...
        image: "./src/assets/icons/Java.png",
        category: "Backend",
    ...
    },
    {
        ...
        image: "./src/assets/icons/Python.png",
        category: "Programming",
    ...
    },
    {
        ...
        image: "./src/assets/icons/DataAnalysis2.png",
    ...
    },
    {
        ...
        image: "./src/assets/icons/Git.png",
        category: "Tools",
            ...
            <div className="container mx-auto px-4 2xl:px-8 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-6 2xl:gap-8">
                    {SKILLS_DATA.map((skill, index) => (
                        <div
                            key={skill.id}
                            className="group relative bg-dark-purple/40 backdrop-blur-sm border border-purple/20 rounded-2xl px-6 py-3 2xl:px-8 2xl:py-6 hover:border-purple/40 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl hover:shadow-purple/10 overflow-hidden"
                            data-aos="zoom-in"
                        ...
                        >
                            ...
                            <div className="mb-2" data-aos="zoom-in" data-aos-delay={(index % 5) * 100 + 100}>
                            ...
                            <h3 className="font-mono text-center text-xl 2xl:text-2xl font-bold text-white mb-3 group-hover:text-pink transition-colors"
                                data-aos="fade-up" data-aos-delay={(index % 5) * 100 + 200}>
                                {skill.title}
                            </h3>

                            <p className="text-light/70 text-center text-sm 2xl:text-base leading-relaxed mb-4 max-h-20"
                               data-aos="fade-up" data-aos-delay={(index % 5) * 100 + 300}>
                                {skill.description}
                            </p>

                            <div className="flex items-center justify-between mt-6 pt-4 border-t border-purple/20"
                                 data-aos="fade-up" data-aos-delay={(index % 5) * 100 + 200}>
